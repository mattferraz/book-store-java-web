 ...
 * @author mtshs
 */
@WebServlet(name = "PerformAddBookServlet", urlPatterns = {"/PerformAddBookServlet"})
public class PerformAddBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        final Book book = new Book(title, description, author, price, copies);
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PerformAddBookServlet</title>");            
            out.println("</head>");
            out.println("<body>");
